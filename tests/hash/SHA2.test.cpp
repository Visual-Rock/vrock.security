...
TEST( SHA224Test, BasicAssertion )
{
    ...
    EXPECT_EQ( vrock::security::hash::SHA2::sha224( data )->to_hex_string( ),
...
TEST( SHA256Test, BasicAssertion )
{
    ...
    EXPECT_EQ( vrock::security::hash::SHA2::sha256( data )->to_hex_string( ),
...
TEST( SHA384Test, BasicAssertion )
{
    ...
    EXPECT_EQ( vrock::security::hash::SHA2::sha384( data )->to_hex_string( ),
...
TEST( SHA512Test, BasicAssertion )
{
    ...
    EXPECT_EQ( vrock::security::hash::SHA2::sha512( data )->to_hex_string( ),
